<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li <?php if ($page == 'komplain') {echo 'class="active"';} ?>>
        <a href="<?php echo base_url('Komplain'); ?>">
          <i class="fa fa-commenting-o"></i>
          <span>Komplain Cabang</span>
        </a>
      </li>

      <li <?php if ($page == 'pu') {echo 'class="active"';} ?>>
        <a href="<?php echo base_url('Pu'); ?>">
          <i class="fa fa-building"></i>
          <span>Potensi PU</span>
        </a>
      </li>

      <li <?php if ($page == 'bpu') {echo 'class="active"';} ?>>
        <a href="<?php echo base_url('Bpu'); ?>">
          <i class="fa fa-male"></i>
          <span>Potensi BPU</span>
        </a>
      </li>
